...
public class MainActivity extends AppCompatActivity implements Asynchtask {
    ...
    public void processFinish(String result) throws JSONException {
        ...
        ArrayList<Revista> lstRevistas = Revista.JsonObjectsBuild(JSONlistaUsuarios);

        AdaptadorRevista adapatorRevista= new AdaptadorRevista(this, lstRevistas);

        lstListaUsuario.setAdapter(adapatorRevista);
